...
1. **Show structures as they are.** Load molecules and materials in standard formats, render them faithfully in the browser, and expose the underlying data instead of hiding it.

2. **Make measurement effortless.** Distance, angle, and coordination environments should be a click away, not a plugin away.
...
Three things make a browser-native viewer the right shape for this moment:

- **WebGL and WebGPU** can now render complex molecular scenes smoothly on ordinary devices.
