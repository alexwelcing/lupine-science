...
- **"508 theorems."** The Lean corpus contains 513 `theorem` declarations and 2 `lemma`s — 515 named results — plus 116 `example` checks, across eight modules. The four families the draft attributed the count to hold 325 of them. Corrected to the true numbers and the true scope.
