...
> **Summary:** The Savings Stack v1 release: a 16-page booklet on compute-savings in atomistic simulation — 72.4% fewer DFT evaluations when four models share anchors, 163 citations verified, every approved public number hashable and reproducible.
> **Status:** Final
> **OG Image:** /articles/the-savings-stack/hero.jpg
> **Artifacts:** [the booklet (PDF)](/booklets/the-savings-stack.pdf) and [the reviewed public claim pack](/data/savings-stack-v1/README.md) with sha256 manifest; supporting quantitative evidence is withheld pending a newly reviewed source contract
> **Ontology:** T6, MC4
...
![The chart: separate model-guidance routes converge on shared reference anchors, making duplicated evaluation work visible without publishing unapproved derived economics](images/spread-chart.jpg)

## The measured core, in one paragraph

On the locked 30-path Z1 panel, path 14 failed CI-NEB convergence in all four model artifacts — the honest denominator is 29. Across those analyzable diffusion paths, the approved public result is **72.4% fewer DFT evaluations.** The value was recomputed from recorded campaign artifacts under the frozen anchor rule; no new DFT was run to produce it. Detailed arithmetic remains in the hashable evidence record rather than being republished as additional public economics.
...
The booklet is the cover story; the [reviewed public claim pack](/data/savings-stack-v1/README.md) is the fail-closed publication contract. It exposes only the approved public economics and a digest manifest. The former quantitative research pack is preserved at `evidence/withheld/savings-stack-v1/`, outside the deployed tree, pending a newly reviewed source contract.
...
`sha256sum -c MANIFEST.sha256` verifies the reviewed public claim pack.
...
- The reviewed public claim pack: [/data/savings-stack-v1/](/data/savings-stack-v1/README.md) — exact approved claims plus digest manifest
- Supporting quantitative evidence: withheld from public deployment pending review

<div class="cta">
  <p><strong>Next:</strong> read the booklet and verify the reviewed public claim pack.</p>
