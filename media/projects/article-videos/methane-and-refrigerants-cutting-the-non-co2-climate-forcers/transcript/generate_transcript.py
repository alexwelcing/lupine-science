...
audio = project / "audio" / "narration-ana-final.wav"
approved = (project / "narration.txt").read_text(encoding="utf-8").strip()
raw_vtt = project / "word-timestamps.json"
outdir = project / "transcript"
outdir.mkdir(exist_ok=True)

TITLE = "Methane and Refrigerants: Cutting the Non-CO₂ Climate Forcers"
...
payload = {
    ...
    "word_count": len(rows),
    "timing_method": "faster-whisper small.en word alignment, corrected to approved narration text and original TTS sentence boundaries",
    "words": rows,
}
