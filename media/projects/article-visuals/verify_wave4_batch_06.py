#!/usr/bin/env python3
"""Render and mechanically certify deterministic Wave-4 batch 06 assets."""
...
from wave4_batch_06_scenes import OUTPUT_DIR, RENDERERS, SPECS, render
...
OUTPUT_MANIFEST = OUTPUT_DIR / "batch-06-manifest.json"
SCENE_SOURCE = Path(__file__).with_name("wave4_batch_06_scenes.py")
