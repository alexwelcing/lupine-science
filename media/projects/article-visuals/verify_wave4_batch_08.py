#!/usr/bin/env python3
"""Render and mechanically certify deterministic Wave-4 batch 08 assets."""
...
from wave4_batch_08_scenes import OUTPUT_DIR, RENDERERS, SPECS, render
...
OUTPUT_MANIFEST = OUTPUT_DIR / "batch-08-manifest.json"
SCENE_SOURCE = Path(__file__).with_name("wave4_batch_08_scenes.py")
