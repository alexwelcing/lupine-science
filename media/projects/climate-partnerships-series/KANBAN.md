# Climate Partnerships Series — Kanban
...
- [ ] Source fact-check
- [ ] Hero asset selection/generation
- [ ] Draft
- [ ] Internal review
- [ ] Build & publish
- [ ] Social card
...
### Cross-cutting: Series landing page
- [ ] Wireframe / structure
- [ ] Copy
- [ ] Hero asset
- [ ] Build & publish

### Cross-cutting: Sitemap update
- [ ] Add series entry
- [ ] Add individual article entries
- [ ] Validate internal links

### Cross-cutting: Social thread
- [ ] Thread narrative arc
- [ ] Pull quotes and cards per article
- [ ] Scheduling

### Cross-cutting: Proof-pack formatting
- [ ] Define proof-pack template
- [ ] Annotate claims for all five articles
- [ ] Generate final proof packs
...
_No items currently under review._

---

## Done

- [x] Project brief (`README.md`)
- [x] Kanban board (`KANBAN.md`)
- [x] Series outline (`OUTLINE.md`)
- [x] Asset brief (`ASSET_BRIEF.md`)
- [x] Article 1 placeholder
- [x] Article 2 placeholder
